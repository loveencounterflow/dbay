(function() {
  'use strict';
  var CND, E, badge, dayjs, debug, echo, help, info, rpr, urge, walk_split_parts, warn, whisper;
  ...
  this.DBay_stdlib = (clasz = Object) => {
    return (function() {
      ...
      _Class = class extends clasz {
        ...
        //---------------------------------------------------------------------------------------------------------
        dt_now() {
          return dayjs().utc().format(this._dt_dbay_timestamp_output_template);
        }
        ...
        dt_parse(dbay_timestamp) {
          ...
          R = (dayjs(dbay_timestamp, this._dt_dbay_timestamp_input_template)).utc();
