  ...
  this.DBay_stdlib = (clasz = Object) => {
    return (function() {
      ...
      _Class = class extends clasz {
        ...
        //---------------------------------------------------------------------------------------------------------
        dt_now() {
          return dayjs().utc().format(this._dt_dbay_timestamp_template);
        }
        ...
        dt_parse(dbay_timestamp) {
          ...
          R = (dayjs(dbay_timestamp, this._dt_dbay_timestamp_template)).utc();
      ...
      // DATETIME (2)
      //---------------------------------------------------------------------------------------------------------
      _Class.prototype._dt_dbay_timestamp_template = 'YYYYMMDD-HHmmssZ';
