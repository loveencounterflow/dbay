(function() {
  'use strict';
  /* https://day.js.org */
  var E, GUY, H, alert, dayjs, debug, echo, help, info, inspect, log, plain, praise, rpr, urge, walk_split_parts, warn, whisper;
  ...
  this.DBay_stdlib = (clasz = Object) => {
    return class extends clasz {
      ...
      //---------------------------------------------------------------------------------------------------------
      _$stdlib_initialize() {
        H.hide(this._me, '_dayjs', dayjs);
        H.hide(this._me, '_dt_dbay_timestamp_input_template', 'YYYYMMDD-HHmmssZ');
        H.hide(this._me, '_dt_dbay_timestamp_output_template', 'YYYYMMDD-HHmmss[Z]');
