(function() {
  'use strict';
  var CND, Dbay_random, E, FS, H, PATH, SQL, badge, debug, echo, guy, help, info, isa, new_bsqlt3_connection, rpr, type_of, types, urge, validate, validate_list_of, warn, whisper;
  ...
  //===========================================================================================================
  this.Dbay = (function() {
    class Dbay extends Dbay_random() {
      //---------------------------------------------------------------------------------------------------------
