(function() {
  'use strict';
  var DBay, DBay_ctx, DBay_openclose, DBay_query, DBay_sqlgen, DBay_stdlib, DBay_udf, E, FS, GUY, H, LFT, PATH, Random, SQL, alert, debug, echo, guy, help, info, inspect, log, new_bsqlt3_connection, plain, praise, rpr, sql, types, urge, warn, whisper;
  ...
  DBay = (function() {
    ...
    class DBay extends DBay_query(DBay_ctx(DBay_openclose(DBay_stdlib(DBay_sqlgen(DBay_udf(Function)))))) {
      ...
      constructor(cfg) {
        ...
        H.configure_with_types(this._me, cfg, types);
        //.......................................................................................................
