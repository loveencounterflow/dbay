(function() {
  'use strict';
  var CND, Dbay_openclose, Dbay_query, Dbay_random, Dbay_tx, E, FS, H, PATH, SQL, badge, debug, echo, guy, help, info, new_bsqlt3_connection, rpr, types, urge, warn, whisper;
