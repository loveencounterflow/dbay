(function() {
  'use strict';
  var CND, Dbay_openclose, Dbay_query, Dbay_random, Dbay_tx, E, FS, H, PATH, SQL, Sql, badge, debug, echo, guy, help, info, new_bsqlt3_connection, rpr, types, urge, warn, whisper;
  ...
  //===========================================================================================================
  this.Dbay = (function() {
    class Dbay extends Dbay_query(Dbay_tx(Dbay_openclose(Dbay_random(Function)))) {
      // overwrite:  false
      // create:     true
