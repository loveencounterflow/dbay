(function() {
  'use strict';
  var CND, E, FS, PATH, SQL, badge, debug, echo, freeze, help, info, lets, rpr, urge, warn, whisper;
  ...
  this.Dbay_tx = (clasz = Object) => {
    return class extends clasz {
      ...
      begin_transaction() {
        throw new E.Dbay_not_implemented('^dbay/tx@1^', "tx_begin");
      }

      commit_transaction() {
        throw new E.Dbay_not_implemented('^dbay/tx@2^', "tx_commit");
      }

      rollback_transaction() {
        throw new E.Dbay_not_implemented('^dbay/tx@3^', "tx_rollback");
      }
      ...
      with_transaction(cfg, f) {
        ...
        switch (arity = arguments.length) {
          ...
          case 2:
            ...
            break;
          default:
            throw new E.Dbay_wrong_arity('^dbay/tx@4^', 'with_transaction()', 1, 2, arity);
        }
        ...
        if (this.sqlt1.inTransaction) {
          throw new E.Dbay_no_nested_transactions('^dbay/tx@5^');
        }
      ...
      with_foreign_keys_deferred(f) {
        ...
        if (this.sqlt.inTransaction) {
          throw new E.Dbay_no_deferred_fks_in_tx('^dbay/tx@6^');
        }
...
//# sourceMappingURL=tx-mixin.js.map