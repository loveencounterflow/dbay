  ...
  this.Dbay_random = (clasz = Object) => {
    return (function() {
      ...
      _Class = class extends clasz {
        //---------------------------------------------------------------------------------------------------------
        _$random_initialize() {
          var delta, ref, ref1, ref2, ref3, ref4, seed;
          clasz = this.constructor;
          if ((ref = clasz._rnd_int_cfg) != null ? ref : false) {
            seed = (ref1 = (ref2 = clasz._rnd_int_cfg) != null ? ref2.seed : void 0) != null ? ref1 : 12.34;
            delta = (ref3 = (ref4 = clasz._rnd_int_cfg) != null ? ref4.delta : void 0) != null ? ref3 : 1;
